...
const displayCart = () => {
  ...
  //Body Modal
  if(cart.length > 0){                //Si hay almenos 1 producto en el carrito que haga todo el modalBody
...
const displayCartCounter = () => {
  const totalProductsQuantity = cart.reduce((acc, product) => acc + product.quantity, 0);
